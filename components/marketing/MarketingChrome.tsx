...
function labelCurrentNavigationItem (navigationItems: Array<navigationItem>, currentNavigationItem: string) {
  return navigationItems.map(item => {
    if (item.name.toLowerCase() === currentNavigationItem.toLowerCase()) {
